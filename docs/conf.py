...
project = "rtorrent-docs"
copyright = "2023, rTorrent Community · CC-BY-SA-4.0"
...
latex_documents = [
    ("index", "rtorrent.tex", "rTorrent Handbook", "pyroscope", "manual"),
]
...
man_pages = [("index", "rtorrent", "rtorrent Handbook", ["pyroscope"], 1)]
